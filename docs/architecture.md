...
个人周报必须通过钉钉 SSO 获取当前 UserID：普通员工仅查看本人；部门或业务组负责人可查看其负责组织的主归属成员；公司负责人和配置的审核人可查看全部有效成员。运维令牌不能模拟个人身份。成员列表还会与当前周报事实中的负责人交集，避免暴露无关人员。旧预览链接进入已失效版本时自动解析到同周期最新可编辑版本；若同周期不存在可编辑版本，则旧版仅可查看。个人页隐藏容易与 TB 项目进度混淆的事项完成率图表和汇总数据。
